...
class GapDetector(Node):
    ...
    def image_cb(self, msg: Image):
        ...
        try:
            ...
            # ---------------- VISUAL UPGRADE #1: LABEL SHELVES ----------------
            ...
            # ---------------- VISUAL UPGRADE #6: Highlight active region ------
            active_width = min(self.active_width, w)
            active_start_x = w - active_width

            # Draw a semi-transparent box on the active (right) region
            ...
            for (front_row, top, bottom) in shelf_intervals:
                ...
                # Zero everything left of active_start_x
                if active_start_x > 0:
            ...
            # ---------------- VISUAL UPGRADE #4: Distance display --------------
            cv2.putText(display,
            ...
            self.get_logger().info(
                f"🟡 dist={dist:.2f} | fronts={len(shelf_fronts)} | gaps={total_gaps} | scale={scale:.2f}"
            )
